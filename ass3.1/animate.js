...
function animateDyson() {
   if (typeof haloA !== 'undefined' && haloA) haloA.rotation.y += 0.01; // rotate halo A around Sun
   if (typeof haloB !== 'undefined' && haloB) haloB.rotation.y += 0.01; // rotate halo B around Sun
   if (typeof haloC !== 'undefined' && haloC) haloC.rotation.y += 0.02; // rotate halo C around Sun
   if (typeof haloD !== 'undefined' && haloD) haloD.rotation.y += 0.02; // rotate halo D around Sun
}
